...
18. **Conflating evidence collection with strategy evaluation.** A `no_agent=true` cron collects and reports deterministic evidence; it does not judge strategy improvement. Pair it with a separate daily agent-mode analyzer for 24h/72h interpretation and promotion decisions.
